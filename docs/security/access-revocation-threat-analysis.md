...
| **Revoked Device Still Has Local Copy** | Adult C's device has full local Core Data database with all records | Adult C can continue viewing old records in offline mode | **Offline-first trade-off**: Cannot remotely wipe data. Mitigation: Server blocks sync, Adult C can't get updates |
