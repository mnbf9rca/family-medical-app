...
struct RepositoryErrorsTests {
    ...
    func errors_areEqual_whenSame() {
        let errorOne = RepositoryError.serializationFailed("error")
        let errorTwo = RepositoryError.serializationFailed("error")
    ...
    func errors_areNotEqual_whenDifferent() {
        let errorOne = RepositoryError.serializationFailed("error1")
        let errorTwo = RepositoryError.serializationFailed("error2")
